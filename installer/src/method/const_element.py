...
class SellInfo(Enum):
    ...
    GAME_CLUB = {
        ...
        'GAME_TITLE_CLICK_VALUE': '',
        'GAME_TITLE_INPUT_VALUE': '',
        'GAME_TITLE_SELECT_VALUE': '',
        'CATEGORY_SELECT_VALUE': '',
        'SELL_TITLE_INPUT_VALUE': '',
        'SELL_EXPLANATION_INPUT_VALUE': '',
        'FIRST_MSG_VALUE': '',
        'CHARGE_VALUE': '',
        'SELL_METHOD_TIME_SALE_VALUE': '',
        'SELL_METHOD_FURIMA_VALUE': '',
        'PRICE_VALUE': '',
        'CHECK_VALUE': '',
        '': '',
        '': '',
